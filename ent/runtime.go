...
func init() {
	...
	usersDescDeleted := usersFields[9].Descriptor()
	...
	usersDescCreatedAt := usersFields[10].Descriptor()
	...
	usersDescUpdatedAt := usersFields[11].Descriptor()
	...
	usersDescID := usersFields[8].Descriptor()
